...
public:
    ...
    property Windows::Foundation::Collections::IVector<byte>^ Bytes
    {
        Windows::Foundation::Collections::IVector<byte>^ get() { return m_interfaceMemberBytes; }
    internal:
        void set(_In_ Windows::Foundation::Collections::IVector<byte>^ value) { m_interfaceMemberBytes = value; }
    }
    
    static IconGetContentResult^ CreateSuccessResult(_In_ Windows::Foundation::Collections::IVector<byte>^ interfaceMemberBytes)
    {
        auto result = ref new IconGetContentResult();
        result->Status = Windows::Devices::AllJoyn::AllJoynStatus::Ok;
        result->Bytes = interfaceMemberBytes;
        result->m_creationContext = Concurrency::task_continuation_context::use_current();
        return result;
    }
...
private:
    int32 m_status;
    Windows::Foundation::Collections::IVector<byte>^ m_interfaceMemberBytes;
};
