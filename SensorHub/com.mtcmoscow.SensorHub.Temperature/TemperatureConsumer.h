...
public:
    ...
    // Get the value of the Celsius property.
    Windows::Foundation::IAsyncOperation<TemperatureGetCelsiusResult^>^ GetCelsiusAsync();

    // Set the value of the Celsius property.
    Windows::Foundation::IAsyncOperation<TemperatureSetCelsiusResult^>^ SetCelsiusAsync(_In_ double value);
    // Get the value of the Fahrenheits property.
    Windows::Foundation::IAsyncOperation<TemperatureGetFahrenheitsResult^>^ GetFahrenheitsAsync();

    // Set the value of the Fahrenheits property.
    Windows::Foundation::IAsyncOperation<TemperatureSetFahrenheitsResult^>^ SetFahrenheitsAsync(_In_ double value);
