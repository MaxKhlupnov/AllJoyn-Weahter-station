...
IAsyncOperation<TemperatureSetCelsiusResult^>^ TemperatureConsumer::SetCelsiusAsync(_In_ double value)
{
    return create_async([this, value]() -> TemperatureSetCelsiusResult^
    {
        ...
        alljoyn_proxybusobject_setpropertyasync(
            ProxyBusObject,
            "com.mtcmoscow.SensorHub.Temperature",
            "Celsius",
            inputArgument,
...
IAsyncOperation<TemperatureGetCelsiusResult^>^ TemperatureConsumer::GetCelsiusAsync()
{
    return create_async([this]() -> TemperatureGetCelsiusResult^
    {
        ...
        result->Celsius = getContext.GetValue();
        return result;
    });
}

IAsyncOperation<TemperatureSetFahrenheitsResult^>^ TemperatureConsumer::SetFahrenheitsAsync(_In_ double value)
{
    return create_async([this, value]() -> TemperatureSetFahrenheitsResult^
    {
        PropertySetContext setContext;
...
IAsyncOperation<TemperatureGetFahrenheitsResult^>^ TemperatureConsumer::GetFahrenheitsAsync()
{
    return create_async([this]() -> TemperatureGetFahrenheitsResult^
    {
        PropertyGetContext<double> getContext;
        ...
        result->Status = getContext.GetStatus();
        result->Fahrenheits = getContext.GetValue();
        return result;
    });
}
...
int32 TemperatureConsumer::JoinSession(_In_ AllJoynServiceInfo^ serviceInfo)
{
    ...
    alljoyn_interfacedescription description = alljoyn_busattachment_getinterface(m_nativeBusAttachment, "com.mtcmoscow.SensorHub.Temperature");
