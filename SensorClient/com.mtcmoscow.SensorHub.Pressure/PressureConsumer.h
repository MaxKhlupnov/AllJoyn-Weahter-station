...
public interface class IPressureConsumer
{
    event Windows::Foundation::TypedEventHandler<PressureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<PressureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<PressureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class PressureConsumer sealed  : [Windows::Foundation::Metadata::Default] IPressureConsumer
{
public:
    PressureConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~PressureConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<PressureJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ PressureWatcher^ watcher);

    // Get the value of the Altitude property.
    Windows::Foundation::IAsyncOperation<PressureGetAltitudeResult^>^ GetAltitudeAsync();

    // Set the value of the Altitude property.
    Windows::Foundation::IAsyncOperation<PressureSetAltitudeResult^>^ SetAltitudeAsync(_In_ double value);
    // Get the value of the InchesOfMercury property.
    Windows::Foundation::IAsyncOperation<PressureGetInchesOfMercuryResult^>^ GetInchesOfMercuryAsync();

    // Set the value of the InchesOfMercury property.
    Windows::Foundation::IAsyncOperation<PressureSetInchesOfMercuryResult^>^ SetInchesOfMercuryAsync(_In_ double value);
    // Get the value of the MmOfMercury property.
    Windows::Foundation::IAsyncOperation<PressureGetMmOfMercuryResult^>^ GetMmOfMercuryAsync();

    // Set the value of the MmOfMercury property.
    Windows::Foundation::IAsyncOperation<PressureSetMmOfMercuryResult^>^ SetMmOfMercuryAsync(_In_ double value);
    // Get the value of the Pascal property.
    Windows::Foundation::IAsyncOperation<PressureGetPascalResult^>^ GetPascalAsync();

    // Set the value of the Pascal property.
    Windows::Foundation::IAsyncOperation<PressureSetPascalResult^>^ SetPascalAsync(_In_ double value);

    // Used to send signals or register functions to handle received signals.
    property PressureSignals^ Signals
    {
        PressureSignals^ get() { return m_signals; }
    }

    // This event will fire whenever the consumer loses the session that it is a member of.
    virtual event Windows::Foundation::TypedEventHandler<PressureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<PressureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<PressureConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
