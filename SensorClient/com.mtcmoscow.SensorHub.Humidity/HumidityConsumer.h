...
public interface class IHumidityConsumer
{
    event Windows::Foundation::TypedEventHandler<HumidityConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<HumidityConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<HumidityConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class HumidityConsumer sealed  : [Windows::Foundation::Metadata::Default] IHumidityConsumer
{
public:
    HumidityConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~HumidityConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<HumidityJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ HumidityWatcher^ watcher);

    // Get the value of the RH property.
    Windows::Foundation::IAsyncOperation<HumidityGetRHResult^>^ GetRHAsync();

    // Set the value of the RH property.
    Windows::Foundation::IAsyncOperation<HumiditySetRHResult^>^ SetRHAsync(_In_ double value);
    ...
    virtual event Windows::Foundation::TypedEventHandler<HumidityConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<HumidityConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<HumidityConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
