...
extern PCSTR c_HumidityIntrospectionXml;

ref class HumidityProducer;

public interface class IHumidityProducer
{
    event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class HumidityProducer sealed : [Windows::Foundation::Metadata::Default] IHumidityProducer
{
public:
    HumidityProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~HumidityProducer();

    // The implementation of IHumidityService that will handle method calls and property requests.
    property IHumidityService^ Service
    {
        IHumidityService^ get() { return m_serviceInterface; }
        void set(IHumidityService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property HumiditySignals^ Signals
    {
        HumiditySignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<HumidityProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    ...
    HumiditySignals^ m_signals;
    IHumidityService^ m_serviceInterface;
