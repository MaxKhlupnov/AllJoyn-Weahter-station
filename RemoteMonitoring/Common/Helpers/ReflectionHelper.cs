...
namespace RemoteMonitoring.Common.Helpers
{
    /// <summary>
    ...
    public static class ReflectionHelper
    {
            ...
            bool exceptionThrownIfNoMatch)
        {
            ...
            PropertyInfo descriptor = default(PropertyInfo);
            foreach (PropertyInfo pd in item.DeclaredProperties)
            {
            ...
            if (descriptor == default(PropertyInfo))
            {
