...
public ref class AboutObjectDescriptionItem sealed
{
public:
...
{
internal:
    static _Check_return_ int32 GetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _Out_ org::alljoyn::About::AboutObjectDescriptionItem^* value)
    {
        UNREFERENCED_PARAMETER(signature);

        (*value) = ref new org::alljoyn::About::AboutObjectDescriptionItem();
    ...
    static _Check_return_ int32 SetAllJoynMessageArg(_In_ alljoyn_msgarg argument, _In_ PCSTR signature, _In_ org::alljoyn::About::AboutObjectDescriptionItem^ value)
    {
        UNREFERENCED_PARAMETER(signature);
